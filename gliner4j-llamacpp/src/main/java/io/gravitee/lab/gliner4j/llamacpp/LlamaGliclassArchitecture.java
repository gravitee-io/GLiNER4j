...
/** The GLiClass uni-encoder family on the llama.cpp engine ({@code "engine": "llamacpp"} bundles). */
public final class LlamaGliclassArchitecture implements ModelArchitecture {
  ...
  public ClassificationStrategy newClassificationStrategy(
    ...
    return LlamaGliclassClassificationStrategy.create(ctx, labels);
  }
}
