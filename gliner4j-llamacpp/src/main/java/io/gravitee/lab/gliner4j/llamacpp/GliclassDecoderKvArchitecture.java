...
/**
 * The GLiClass {@code decoder-kv} family (Qwen3 backbone on llama.cpp + ONNX scorer), registered
 * with {@link io.gravitee.lab.gliner4j.arch.ModelArchitectures} through {@code META-INF/services}.
 */
public final class GliclassDecoderKvArchitecture implements ModelArchitecture {
  ...
  public ClassificationStrategy newClassificationStrategy(
    ...
    return new DecoderKvClassificationStrategy(
